 ...
 */
    ...
    override fun onRequestPermissionsResult(
        ...
        if (grantResults.isEmpty() || grantResults[LOCATION_PERMISSION_INDEX] == PERMISSION_DENIED || (requestCode == REQUEST_FOREGROUND_AND_BACKGROUND_PERMISSION_RESULT_CODE && grantResults[BACKGROUND_LOCATION_PERMISSION_INDEX] == PERMISSION_DENIED)) {
            Snackbar.make(
    ...
    private fun requestForegroundAndBackgroundLocationPermissions() {
        ...
        ActivityCompat.requestPermissions(
            this@HuntMainActivity, permissionsArray, resultCode
        )
    }
